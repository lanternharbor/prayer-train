...
export const plTranslations: PrayerTranslationSeed[] = [
  ...
  },
  {
    ...
    name: "Nowenna do świętej Gianny Beretty Molli (Patronka Matek w Trudnych Ciążach)",
    description:
      "Święta Gianna Beretta Molla (1922-1962) jest nowoczesną włoską patronką matek przeżywających ciąże wysokiego ryzyka, kobiet zamężnych, pracujących matek i lekarzy. Urodziła się w Magenta w Lombardii, jako dziesiąte z trzynaściorga dzieci w mediolańsko-katolickiej rodzinie głębokiej pobożności (dwóch jej braci zostało kapłanami, dwie z sióstr — zakonnicami). Ukończyła medycynę w Pawii, specjalizując się w pediatrii i położnictwie, i prowadziła kwitnący gabinet we wsi Mesero pod Mediolanem przez całe lata pięćdziesiąte. Była jednocześnie czynnym lekarzem, katoliczką wierną codziennej Mszy świętej, doświadczoną pianistką, dobrą narciarką, a od 1955 żoną Pietra Molli (inżyniera w fabryce zapałek SAFFA, który zalecał się do niej w chórze parafialnym) i matką rosnącej rodziny: Pierluigi (1956), Mariolina (1957) i Laura (1959). Decydujący moment jej świętości nadszedł we wrześniu 1961 wraz z czwartą ciążą. Po dwóch miesiącach lekarze wykryli włókniaka macicy — duży łagodny guz, który bez leczenia zagrażał zarówno jej życiu, jak i rozwijającemu się dziecku. Dostępne były trzy opcje medyczne: całkowita histerektomia (ratująca Giannę, ale kończąca ciążę i jej przyszłą płodność, teologicznie dopuszczalna przez zasadę podwójnego skutku); usunięcie włókniaka wraz z aborcją (niedopuszczalne — bezpośrednie zabicie dziecka); lub samo usunięcie włókniaka, pozostawiające ciążę w wysokim ryzyku, ale ratujące dziecko. Gianna wybrała trzecią drogę i poinstruowała zespół chirurgiczny: «Jeśli musicie wybierać między matką a dzieckiem, wybierzcie dziecko. Nalegam: wybierzcie dziecko. Ratujcie dziecko». Przeszła przez ciążę w fizycznie wyczerpujących ostatnich miesiącach. W Wielką Sobotę, 21 kwietnia 1962, urodziła zdrową córkę — Giannę Emanuelę. Tydzień później, 28 kwietnia, Gianna Beretta Molla zmarła na septyczne zapalenie otrzewnej w wieku 39 lat. Beatyfikował ją św. Jan Paweł II 24 kwietnia 1994 (w obecności jej męża Pietra i żyjących dzieci) i kanonizował 16 maja 2004, z owdowiałym mężem, córką i synem obecnymi — pierwsza kanonizacja w historii Kościoła katolickiego, podczas której małżonek świętej żył i był obecny. Nowenna jest właściwa dla: każdej ciąży wysokiego ryzyka; ciąży, w której zagrożone jest zdrowie matki; rodzin w OIOM noworodka (gdzie wykształcenie medyczne Gianny jako pediatry jest szczególnym punktem identyfikacji); kobiet rozważających trudne decyzje medyczne w czasie ciąży; niepłodności i powrotu do równowagi po poronieniu; małżeństw rozeznających dar życia; oraz pracujących matek szukających integracji powołania zawodowego i macierzyństwa, którą Gianna ucieleśniła bez kompromisów. Jej córka Gianna Emanuela — sama dziś lekarka — publicznie mówi o świadectwie matki i była obecna na Synodzie 2024.",
    prayerText:
      "Boże, nasz Ojcze, w świętej Giannie Berettcie Molli dałeś nam żonę, matkę i lekarkę, która żyła powołaniem małżeństwa i godnością życia jako jeden ciągły dar. Przez jej wstawiennictwo udziel nam łaski, o którą teraz prosimy (wymień intencję). Prosimy szczególnie za matki noszące trudne ciąże — niech znajdą w Giannie siostrę i orędowniczkę; za rodziny stające wobec niemożliwych decyzji medycznych w łonie matki — niech otrzymają mądrość, którą otrzymała Gianna, i ufność, by wybrać dar życia z pokorą i nadzieją; za pracujące matki — niech zintegrują swoje powołania, jak Gianna zintegrowała medycynę i macierzyństwo; za nienarodzone dziecko kochane i oczekiwane z bojaźnią i drżeniem — niech to dziecko będzie chronione, kształtowane i bezpiecznie doprowadzone do dnia narodzin. Święta Gianno, która wybrałaś życie swojej córki nad swoje i umarłaś w pewności zmartwychwstania, módl się za nami. Amen.",
    instructions:
      "Odmawiaj raz dziennie przez dziewięć kolejnych dni. Nowenna jest tradycyjnie odmawiana w dziewięciu dniach poprzedzających jej święto (28 kwietnia, data jej śmierci) lub w dziewięciu dniach przed Uroczystością Zwiastowania Pańskiego (25 marca, wielka uroczystość Wcielenia, która obejmuje każdą katolicką modlitwę za matki i nienarodzone dzieci). Nowenna jest również właściwa w każdym momencie ostrej decyzji medycznej podczas ciąży: przy diagnozie wady płodu, po trudnym USG, podczas długiego pobytu w szpitalu, przy łóżeczku w OIOM noworodka. Struktura: (1) Znak Krzyża; (2) modlitwa nowenny; (3) dziesiątka różańca, najlepiej tajemnic radosnych (Zwiastowanie, Nawiedzenie, Narodzenie, Ofiarowanie, Znalezienie w świątyni) — pięć tajemnic, które przebiegają duchowy łuk macierzyństwa, którym żyła Gianna; (4) Memorare (Pomnij); (5) wymień matkę, dziecko i intencję po imieniu. Łącz nowennę z dwiema praktykami dewocyjnymi, które sama Gianna zachowywała: codziennym uczestnictwem we Mszy świętej (centralny filar jej duchowości) i konsekracją małżeństwa Świętej Rodzinie Jezusa, Maryi i Józefa (Gianna i Pietro dokonali tej konsekracji przed ślubem i odnawiali ją corocznie). Dla rodzin w OIOM noworodka: nowennę można odmawiać przy łóżeczku, w ciszy, fragmentarycznie — święta matek, które nie mogły leżeć spokojnie podczas trudnej ciąży, rozumie modlitwę odmawianą w chaosie. Włoska tradycja dewocyjna zaleca pielgrzymkę do Mesero (kościół parafialny San Martino, gdzie pochowana jest Gianna). Polscy katolicy często czczą ją wizerunkami parafialnymi umieszczonymi przy wejściach na oddziały położnicze katolickich szpitali.",
    patronSaint: "Święta Gianna Beretta Molla",
    feastDay: "28 kwietnia",
    source: "KEP + Vatican.va polski (Jan Paweł II, kanonizacja 16 maja 2004, homilia) + Fondazione Gianna Beretta Molla + Pietro Molla, Saint Gianna Molla: Wife, Mother, Doctor (Ignatius Press, 2004). Retrieved 2026-05-19.",
  ...
  },
  {
    ...
    prayerText:
      "Od przekonania, że muszę zasłużyć na Twoją miłość, wybaw mnie, Jezu.\nOd lęku, że jestem niegodny miłości, wybaw mnie, Jezu.\nOd fałszywej pewności, że mam to, co potrzebne, wybaw mnie, Jezu.\nOd lęku, że zaufanie Tobie zostawi mnie jeszcze bardziej ogołoconym, wybaw mnie, Jezu.\nOd wszelkich podejrzeń wobec Twoich słów i obietnic, wybaw mnie, Jezu.\nOd buntu przeciw dziecięcej zależności od Ciebie, wybaw mnie, Jezu.\nOd odmów i niechęci w przyjmowaniu Twojej woli, wybaw mnie, Jezu.\nOd lęku o przyszłość, wybaw mnie, Jezu.\nOd urazy lub nadmiernego zaprzątania się przeszłością, wybaw mnie, Jezu.\nOd niespokojnego szukania siebie w obecnej chwili, wybaw mnie, Jezu.\nOd niedowierzania Twojej miłości i obecności, wybaw mnie, Jezu.\nOd lęku, że poprosisz mnie o więcej, niż mam, wybaw mnie, Jezu.\nOd przekonania, że moje życie nie ma sensu ani wartości, wybaw mnie, Jezu.\nOd lęku przed tym, czego wymaga miłość, wybaw mnie, Jezu.\nOd zniechęcenia, wybaw mnie, Jezu.\n\nŻe nieustannie podtrzymujesz mnie w istnieniu, Jezu, ufam Tobie.\nŻe mnie kochasz, Jezu, ufam Tobie.\nŻe mnie widzisz, Jezu, ufam Tobie.\nŻe mnie słyszysz, Jezu, ufam Tobie.\nŻe mnie znasz, Jezu, ufam Tobie.\nŻe widzisz przeszłość, teraźniejszość i przyszłość, i wiesz, czego potrzebuję, Jezu, ufam Tobie.\nŻe zatroszczysz się o mnie, Jezu, ufam Tobie.\nŻe mnie wybawisz, Jezu, ufam Tobie.\nŻe jesteś cichy i pokornego serca, Jezu, ufam Tobie.\nŻe jesteś wiecznie wierny, Jezu, ufam Tobie.\nŻe wszystko przemija, a tylko Twoja miłość trwa, Jezu, ufam Tobie.\nŻe wyprowadzasz prawdziwe dobro z każdej sytuacji, Jezu, ufam Tobie.\nŻe nauczysz mnie ufać Tobie, Jezu, ufam Tobie.\nŻe jesteś moim Panem i moim Bogiem, Jezu, ufam Tobie.\nŻe jestem Twoim umiłowanym, Jezu, ufam Tobie. Amen.",
    instructions:
    ...
    patronSaint: "Siostra Faustyna Maria Pia, SV (Sisters of Life — autorka)",
    feastDay: null,
    source: "KEP + Sisters of Life (sistersoflife.org/litany-of-trust, autoryzowane do reprodukcji dewocyjnej). Retrieved 2026-05-19.",
    reviewedAt: new Date("2026-05-19"),
  },
  {
    ...
    description:
      "Salve Regina — znana po polsku jako «Witaj Królowo» — to jedna z czterech antyfon maryjnych Brewiarza Rzymskiego i najbardziej ukochana krótka maryjna modlitwa polskojęzycznego świata katolickiego. Tradycyjnie przypisywana jest błogosławionemu Hermanowi Kalece (Hermanowi z Reichenau, 1013-1054), benedyktyńskiemu mnichowi z opactwa Reichenau w południowych Niemczech, który od urodzenia cierpiał na poważną niepełnosprawność fizyczną i który, nie mogąc chodzić, z trudnością mówiąc i będąc częściowo głuchym, został rozpoznany przez mnichów dzięki swoim niezwykłym darom intelektualnym: napisał traktaty z astronomii, teorii muzyki i matematyki, skomponował hymny liturgiczne i, według tradycji XI wieku, skomponował Salve Regina pod koniec swojego życia. Czułość modlitwy — zwracająca się do Maryi jako «życie, słodyczy i nadziejo nasza» — i jej szczere uznanie ludzkiego cierpienia («płacząc i jęcząc w tej łez dolinie») odzwierciedlają doświadczenie człowieka, który znał życie niezwykłego fizycznego ograniczenia. Salve Regina weszła do uniwersalnego katolickiego użytku poprzez Zakon Cysterski w XII wieku i została przyjęta jako antyfona zamykająca Komplety. Po Soborze Trydenckim stała się modlitwą zamykającą Różaniec Święty w tradycji dominikańskiej. W Polsce «Witaj Królowo» jest jedną z pierwszych modlitw, których uczą się dzieci w rodzinie, odmawiana wieczorem przed snem, w maryjnych pielgrzymkach (szczególnie na Jasną Górę — Sanktuarium Matki Bożej Częstochowskiej, Królowej Polski) i jako zakończenie każdej maryjnej nowenny. Modlitwa jest właściwie odmawiana: na zakończenie każdego Różańca Świętego; w wieczornej modlitwie rodzinnej; przy łóżku osoby ciężko chorej lub umierającej; w miesiącach maryjnych (maj i październik); na zakończenie każdej nowenny maryjnej; i jako katolicka modlitwa «schronienia» — ta, której polskie katolickie serce szuka spontanicznie w chwilach bólu.",
    prayerText:
      "Witaj Królowo, Matko Miłosierdzia,\nżycie, słodyczy i nadziejo nasza, witaj!\nDo Ciebie wołamy wygnańcy, synowie Ewy.\nDo Ciebie wzdychamy, jęcząc i płacząc\nna tym łez padole.\nPrzeto, Orędowniczko nasza,\nOne miłosierne oczy Twoje na nas zwróć.\nA Jezusa, błogosławiony owoc żywota Twojego,\npo tym wygnaniu nam okaż.\nO łaskawa, o litościwa, o słodka Panno Maryjo!\n\nMódl się za nami, święta Boża Rodzicielko,\nabyśmy się stali godnymi obietnic Chrystusowych.\n\nAmen.",
    instructions:
      "Odmów raz z pełną uwagą. Salve Regina jest krótka — około 150 słów — i katolicy zwykle uczą się jej na pamięć. Tradycyjna struktura to pełny tekst modlitwy, po nim wersyklu-odpowiedź «Módl się za nami, święta Boża Rodzicielko / Abyśmy się stali godnymi obietnic Chrystusowych» oraz końcowa kolekta. Właściwie odmawiana: na zakończenie każdego Różańca Świętego (jest to uniwersalna katolicka konwencja dewocyjna); przy łóżku osoby w jej ostatnich godzinach (Salve Regina jest jedną z wielkich modlitw oddania); po każdej maryjnej nowennie; podczas pogrzebów księży, osób konsekrowanych i każdego katolika szczególnie oddanego Maryi. Łaciński oryginał («Salve, Regina, mater misericordiae…») jest uroczyście śpiewany w wielu polskich parafiach w maju i październiku. Naucz «Witaj Królowo» dzieci wcześnie — to jedna z czterech lub pięciu katolickich modlitw, których polskie dziecko powinno się nauczyć przed Pierwszą Komunią Świętą, obok Znaku Krzyża, Ojcze Nasz, Zdrowaś Maryjo i Chwała Ojcu.",
    patronSaint: "Błogosławiony Herman Kaleka z Reichenau (autor przypisywany)",
    feastDay: null,
    source: "KEP (Konferencja Episkopatu Polski, oficjalny tekst liturgiczny) + Vatican.va polski + tradycja cysterska (XII w.) + Jasna Góra (Sanktuarium Matki Bożej Częstochowskiej). Retrieved 2026-05-19.",
    reviewedAt: new Date("2026-05-19"),
  },
];
