...
export const ptBRTranslations: PrayerTranslationSeed[] = [
  ...
  },
  {
    ...
    name: "Salve Rainha",
    description:
      "A Salve Rainha — conhecida em português como «Salve, Rainha, Mãe de misericórdia» — é uma das quatro antífonas marianas do Breviário Romano e a oração mariana breve mais amada do mundo católico de língua portuguesa. É tradicionalmente atribuída ao Beato Hermano, o Coxo, de Reichenau (1013-1054), monge beneditino do mosteiro de Reichenau no sul da Alemanha, que sofria de uma grave deficiência física desde o nascimento e que, sem conseguir andar, com dificuldade para falar e parcialmente surdo, foi reconhecido pelos monges por seus extraordinários dons intelectuais: escreveu tratados de astronomia, teoria musical e matemática, compôs hinos litúrgicos e, segundo a tradição do século XI, compôs a Salve Rainha no fim de sua vida. A ternura da oração — dirigindo-se a Maria como «vida, doçura e esperança nossa» — e seu reconhecimento honesto do sofrimento humano («gemendo e chorando neste vale de lágrimas») refletem a experiência de um homem que conheceu uma vida de limitação física incomum. A Salve Rainha entrou no uso católico universal através da Ordem Cisterciense no século XII (São Bernardo de Claraval foi particular defensor) e foi adotada como a antífona de encerramento das Completas. Após o Concílio de Trento, tornou-se a oração de encerramento do Santo Terço na tradição dominicana — e por meio dos dominicanos, em todo o catolicismo latino. No Brasil, a Salve Rainha é uma das primeiras orações que as crianças aprendem, rezada em família antes de dormir, em peregrinações marianas (especialmente em Aparecida — a Padroeira do Brasil) e como encerramento de toda novena mariana. É apropriada para: o final de cada Santo Terço; a oração noturna familiar; ao lado de um doente grave ou moribundo; durante os meses marianos de maio e outubro; ao final de qualquer novena mariana; e como a oração católica «de refúgio» — aquela que o coração católico brasileiro busca espontaneamente em momentos de dor.",
    prayerText:
      "Salve, Rainha, Mãe de misericórdia,\nvida, doçura e esperança nossa, salve!\nA vós bradamos, os degredados filhos de Eva.\nA vós suspiramos, gemendo e chorando\nneste vale de lágrimas.\nEia, pois, advogada nossa,\nesses vossos olhos misericordiosos a nós volvei.\nE depois deste desterro,\nmostrai-nos Jesus, bendito fruto do vosso ventre.\nÓ clemente, ó piedosa, ó doce sempre Virgem Maria!\n\nRogai por nós, Santa Mãe de Deus,\npara que sejamos dignos das promessas de Cristo.\n\nAmém.",
    instructions:
      "Reze uma vez com plena atenção. A Salve Rainha é breve — cerca de 150 palavras — e os católicos costumam memorizá-la. A estrutura tradicional é o texto completo da oração, seguido do versículo-resposta «Rogai por nós, Santa Mãe de Deus / Para que sejamos dignos das promessas de Cristo» e uma oração conclusiva. Apropriada: ao final de cada Santo Terço (esta é a convenção devocional católica universal); como antífona de encerramento das Completas; ao lado de alguém em suas horas finais (a Salve Rainha é uma das grandes orações de encomendação); após qualquer novena mariana; durante os ritos funerários de sacerdotes, religiosos e todo católico particularmente devoto de Maria. O original latino («Salve, Regina, mater misericordiae…») é cantado solenemente em muitas paróquias brasileiras durante maio e outubro. Ensine a Salve Rainha às crianças desde cedo — é uma das quatro ou cinco orações católicas que uma criança brasileira deve aprender antes da Primeira Eucaristia, junto ao Sinal da Cruz, Pai-Nosso, Ave-Maria e Glória ao Pai.",
    patronSaint: "Beato Hermano de Reichenau (autor atribuído)",
    feastDay: null,
    source: "CNBB (texto litúrgico oficial em português) + Vatican.va Português + tradição cisterciense (séc. XII) + Aparecida (Santuário Nacional). Retrieved 2026-05-19.",
    reviewedAt: new Date("2026-05-19"),
  },
];
