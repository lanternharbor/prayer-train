...
const COPY: Record<Locale, Copy> = {
  ...
  es: {
    ...
    encouragementBody:
      "Comenzamos PrayerTrain porque lo necesitábamos. Tres niños de nuestra familia enfrentaron situaciones médicas graves en cuestión de meses, a finales de 2025 y principios de 2026, y seguíamos encontrando que las personas que nos amaban querían orar pero no sabían cómo coordinarse. PrayerTrain es la herramienta que deseábamos haber tenido. Es gratis porque el amor que fluye a través de una cadena de oración no es nuestro para monetizar — es una participación en el cuidado mismo de Dios por las personas que amas.",
  ...
  fil: {
    ...
    encouragementBody:
      "Sinimulan namin ang PrayerTrain dahil kailangan namin ito. Tatlong bata sa aming pamilya ang humarap sa malulubhang medikal na sitwasyon sa loob ng ilang buwan, sa huling bahagi ng 2025 at simula ng 2026, at patuloy naming nakikitang ang mga taong nagmamahal sa amin ay gustong magdasal pero hindi alam kung paano mag-coordinate. Ang PrayerTrain ay ang kasangkapang sana ay nakapagsamantala namin. Libre ito dahil ang pag-ibig na umaagos sa isang prayer train ay hindi sa amin upang pagkakitaan — ito ay pakikilahok sa sariling pag-aalaga ng Diyos para sa mga taong mahal mo.",
