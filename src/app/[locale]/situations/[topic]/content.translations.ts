...
const sickChildFil: SituationContent = {
  ...
  prayers: [
    ...
    { slug: "psalm-91", why: "Iuutos Niya sa Kanyang mga anghel na ingatan ka sa lahat ng iyong landas. Ang Awit 91 ay isa sa mga panalanging dinasal ng aming pamilya sa tatlong NICU stay. Hindi ito nangangako ng kalalabasan. Nangangako ito ng presensya." },
  ],
